...
print(dateRange)
dateRange=pd.date_range(start="12-02-2025",periods=5,freq='M')
print(dateRange)
dateRange=pd.date_range(start="12-02-2025",periods=5,freq='Y')
print(dateRange)
dateRange=pd.date_range(start="12-02-2025",periods=5,freq='D')
print(dateRange)
